import { AlotHaShaharKey, NetzKey, SofBirkotKeriatShemaGraKey, SofBirkotKeriatShemaMagenAvrahamKey, SofShemaGraKey, SofShemaMagenAvrahamKey, TallitAndTefillinKey } from "../constants/times.keys"
...
export const cities: { [key: string]: { lat: number, long: number } } = {
    ...
    [CitiesEnum.NETIVOT]: { lat: 31.421984, long: 34.7935883 },
...
export const nameConfiguration: { [key: string]: string } = {
    alotAshahar: "עלות השחר",
    talitTfilin: "זמן ציצית ותפילין",
    netz: "הנץ החמה",
    sofShmaMagenAvraham: 'ס"ז ק"ש מ"א',
    sofShmaGra: 'סוף זמן ק"ש',
    sofBirkotSmaMagenAvraham: 'ס"ז תפילה מ"א',
    sofBirkotShmaGra: 'ס"ז תפילה',
    minchaGedola: "מנחה גדולה",
    minchaKetana: "מנחה קטנה",
    plagMincha: "פלג מנחה",
    nerotShabat: "הדלקת נרות",
    shkiha: "שקיעה",
    tzatCochavimG: "צאת כוכבים",
    tzetTzom: "צאת צום",
    tzetShabat: "צאת שבת",
    tzatCochavimRT: "רבינו תם",
    hatzotYom: "חצות יום",
    hatzotLila: "חצות לילה"
}
