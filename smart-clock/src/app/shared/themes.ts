...
export const VARIANTS: Record<string, { dark: ThemeVariant; light: ThemeVariant }> = {
    blue: {
        dark: {
            ...
            textPrimary: '#e2e8f0', textSecondary: '#b0bec9', textMuted: '#a6b3bf',
            timeColor: '#7db8ff', divider: 'rgba(52,211,153,0.2)', cardActive: 'rgba(52,211,153,0.08)',
        ...
        light: {
            ...
            accent: '#046c4e', accentGlow: 'rgba(16,185,129,0.18)', accentMuted: 'rgba(16,185,129,0.14)',
            textPrimary: '#0f172a', textSecondary: '#1e293b', textMuted: '#434e62',
            timeColor: '#1842b5', divider: 'rgba(16,185,129,0.22)', cardActive: 'rgba(16,185,129,0.07)',
    ...
    purple: {
        dark: {
            ...
            textPrimary: '#ede9fe', textSecondary: '#c4b5fd', textMuted: '#aea4e2',
            timeColor: '#a5afff', divider: 'rgba(167,139,250,0.2)', cardActive: 'rgba(167,139,250,0.09)',
        ...
        light: {
            ...
            accent: '#6d28d9', accentGlow: 'rgba(139,92,246,0.18)', accentMuted: 'rgba(139,92,246,0.12)',
            textPrimary: '#1e1b4b', textSecondary: '#312e81', textMuted: '#4035c0',
            timeColor: '#5b21b6', divider: 'rgba(139,92,246,0.2)', cardActive: 'rgba(139,92,246,0.07)',
            panelBg: 'rgba(255,255,255,0.98)',
        },
    },
    orange: {
        dark: {
            ...
            textPrimary: '#fff7ed', textSecondary: '#fdba74', textMuted: '#d9a17a',
        ...
        light: {
            ...
            accent: '#a9390a', accentGlow: 'rgba(234,88,12,0.18)', accentMuted: 'rgba(234,88,12,0.12)',
            textPrimary: '#431407', textSecondary: '#7c2d12', textMuted: '#7c2d12',
            timeColor: '#7c2d12', divider: 'rgba(234,88,12,0.2)', cardActive: 'rgba(234,88,12,0.06)',
            panelBg: 'rgba(255,255,255,0.98)',
        },
    },
    red: {
        dark: {
            ...
            textPrimary: '#fff1f2', textSecondary: '#fda4af', textMuted: '#e791aa',
            timeColor: '#ff8a8a', divider: 'rgba(251,113,133,0.2)', cardActive: 'rgba(251,113,133,0.08)',
        ...
        light: {
            ...
            accent: '#b91c1c', accentGlow: 'rgba(225,29,72,0.16)', accentMuted: 'rgba(225,29,72,0.12)',
            textPrimary: '#4c0519', textSecondary: '#881337', textMuted: '#991137',
            timeColor: '#881337', divider: 'rgba(225,29,72,0.2)', cardActive: 'rgba(225,29,72,0.06)',
            panelBg: 'rgba(255,255,255,0.98)',
        },
    },
    teal: {
        dark: {
            ...
            textPrimary: '#f0fdfa', textSecondary: '#5eead4', textMuted: '#71bcb6',
        ...
        light: {
            ...
            accent: '#0e6a63', accentGlow: 'rgba(13,148,136,0.18)', accentMuted: 'rgba(13,148,136,0.12)',
            textPrimary: '#042f2e', textSecondary: '#134e4a', textMuted: '#105753',
            timeColor: '#135468', divider: 'rgba(13,148,136,0.2)', cardActive: 'rgba(13,148,136,0.06)',
            panelBg: 'rgba(255,255,255,0.98)',
        },
    },
    cyan: {
        dark: {
            ...
            textPrimary: '#ecfeff', textSecondary: '#67e8f9', textMuted: '#5fb8d4',
        ...
        light: {
            ...
            accent: '#0c6780', accentGlow: 'rgba(8,145,178,0.18)', accentMuted: 'rgba(8,145,178,0.12)',
            textPrimary: '#083344', textSecondary: '#164e63', textMuted: '#135468',
            timeColor: '#06527a', divider: 'rgba(8,145,178,0.2)', cardActive: 'rgba(8,145,178,0.06)',
            panelBg: 'rgba(255,255,255,0.98)',
        },
    },
    green: {
        dark: {
            ...
            textPrimary: '#f0fdf4', textSecondary: '#86efac', textMuted: '#6ac48a',
        ...
        light: {
            ...
            accent: '#126d34', accentGlow: 'rgba(22,163,74,0.18)', accentMuted: 'rgba(22,163,74,0.12)',
            textPrimary: '#052e16', textSecondary: '#14532d', textMuted: '#13592e',
            timeColor: '#13592e', divider: 'rgba(22,163,74,0.2)', cardActive: 'rgba(22,163,74,0.06)',
            panelBg: 'rgba(255,255,255,0.98)',
        },
    },
    pink: {
        dark: {
            ...
            textPrimary: '#fdf2f8', textSecondary: '#f9a8d4', textMuted: '#e594b6',
            timeColor: '#f09cff', divider: 'rgba(244,114,182,0.2)', cardActive: 'rgba(244,114,182,0.08)',
        ...
        light: {
            ...
            accent: '#b61759', accentGlow: 'rgba(219,39,119,0.18)', accentMuted: 'rgba(219,39,119,0.12)',
            textPrimary: '#500724', textSecondary: '#831843', textMuted: '#951649',
            timeColor: '#86198f', divider: 'rgba(219,39,119,0.2)', cardActive: 'rgba(219,39,119,0.06)',
            panelBg: 'rgba(255,255,255,0.98)',
        },
    },
    indigo: {
        dark: {
            ...
            textPrimary: '#eef2ff', textSecondary: '#a5b4fc', textMuted: '#a2a8e5',
            timeColor: '#7db8ff', divider: 'rgba(129,140,248,0.2)', cardActive: 'rgba(129,140,248,0.08)',
        ...
        light: {
            ...
            textPrimary: '#1e1b4b', textSecondary: '#312e81', textMuted: '#3730a3',
            timeColor: '#1e40af', divider: 'rgba(79,70,229,0.2)', cardActive: 'rgba(79,70,229,0.06)',
            panelBg: 'rgba(255,255,255,0.98)',
        },
    },
    amber: {
        dark: {
            ...
            textPrimary: '#fffbeb', textSecondary: '#fcd34d', textMuted: '#daa47f',
        ...
        light: {
            ...
            accent: '#9b4708', accentGlow: 'rgba(217,119,6,0.18)', accentMuted: 'rgba(217,119,6,0.12)',
            textPrimary: '#451a03', textSecondary: '#78350f', textMuted: '#80380c',
            timeColor: '#80380c', divider: 'rgba(217,119,6,0.2)', cardActive: 'rgba(217,119,6,0.06)',
            panelBg: 'rgba(255,255,255,0.98)',
        },
    },
    slate: {
        dark: {
            ...
            textPrimary: '#f8fafc', textSecondary: '#cbd5e1', textMuted: '#a6b3bf',
            timeColor: '#a0b2c5', divider: 'rgba(148,163,184,0.2)', cardActive: 'rgba(148,163,184,0.08)',
        ...
        light: {
            ...
            textPrimary: '#0f172a', textSecondary: '#1e293b', textMuted: '#414e61',
